...
inline bool VerifyMessageBuffer(
  ...
  return verifier.template VerifyBuffer<encrypto::motion::communication::Message>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedMessageBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<encrypto::motion::communication::Message>(nullptr);
}
