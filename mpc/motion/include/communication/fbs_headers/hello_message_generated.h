...
struct HelloMessage FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint16_t>(verifier, VT_SOURCE_ID, 2) &&
           VerifyField<uint16_t>(verifier, VT_DESTINATION_ID, 2) &&
           VerifyField<uint16_t>(verifier, VT_NUMBER_OF_PARTIES, 2) &&
           ...
           VerifyField<uint8_t>(verifier, VT_ONLINE_AFTER_SETUP, 1) &&
           VerifyField<uint16_t>(verifier, VT_MOTION_VERSION_MAJOR, 2) &&
           VerifyField<uint16_t>(verifier, VT_MOTION_VERSION_MINOR, 2) &&
           VerifyField<uint16_t>(verifier, VT_MOTION_VERSION_PATCH, 2) &&
           verifier.EndTable();
  }
};
...
inline bool VerifyHelloMessageBuffer(
  ...
  return verifier.template VerifyBuffer<encrypto::motion::communication::HelloMessage>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedHelloMessageBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<encrypto::motion::communication::HelloMessage>(nullptr);
}
